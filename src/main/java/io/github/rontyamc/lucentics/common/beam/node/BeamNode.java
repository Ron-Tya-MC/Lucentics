...
public record BeamNode(ResourceLocation blockId, BlockPos pos, ResourceKey<Level> dimension, boolean isEndpoint) {
    public static final Codec<BeamNode> CODEC = RecordCodecBuilder.create(ins -> ins.group(
            ...
            Codec.BOOL.fieldOf("is_endpoint").forGetter(BeamNode::isEndpoint)
