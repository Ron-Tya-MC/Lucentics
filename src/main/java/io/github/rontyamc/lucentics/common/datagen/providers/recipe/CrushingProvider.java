...
public class CrushingProvider {
    ...
    protected static void buildRecipes(LucenticsRecipeProvider provider, RecipeOutput recipeOutput) {
        ...
        provider.generic()
                .suffix("_with_copper_hammer")
                .crushing(b -> b.input(Blocks.GLASS)
                        .output(OutputSpec.of(LucenticsItemRegister.GLASS_SHERD).count(UniformInt.of(2,3)))
                        .tool(LucenticsItemRegister.COPPER_HAMMER)
                        .clickSound(SoundSpec.of(SoundEvents.GLASS_HIT, SoundSource.BLOCKS))
                        .breakSound(SoundSpec.of(SoundEvents.GLASS_BREAK, SoundSource.BLOCKS))
                        .damagePerHit(2)
                        .requiredHits(2));
        provider.generic()
                .suffix("_with_iron_hammer")
                .crushing(b -> b.input(Blocks.GLASS)
                        .output(OutputSpec.of(LucenticsItemRegister.GLASS_SHERD).count(UniformInt.of(3,4)))
                        .tool(LucenticsItemRegister.IRON_HAMMER)
                        .clickSound(SoundSpec.of(SoundEvents.GLASS_HIT, SoundSource.BLOCKS))
                        .breakSound(SoundSpec.of(SoundEvents.GLASS_BREAK, SoundSource.BLOCKS))
                        .damagePerHit(2)
        ...
        provider.generic()
                .suffix("_with_golden_hammer")
                .crushing(b -> b.input(Blocks.GLASS)
                        .output(OutputSpec.of(LucenticsItemRegister.GLASS_SHERD).count(4))
                        .tool(LucenticsItemRegister.GOLDEN_HAMMER)
                        .clickSound(SoundSpec.of(SoundEvents.GLASS_HIT, SoundSource.BLOCKS))
                        .breakSound(SoundSpec.of(SoundEvents.GLASS_BREAK, SoundSource.BLOCKS))
                        .damagePerHit(4)
