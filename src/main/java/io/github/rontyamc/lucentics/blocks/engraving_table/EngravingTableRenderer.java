package io.github.rontyamc.lucentics.blocks.engraving_table;
...
public class EngravingTableRenderer implements BlockEntityRenderer<EngravingTableBlockEntity> {
    public EngravingTableRenderer(BlockEntityRendererProvider.Context context) {}
