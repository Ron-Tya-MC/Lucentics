...
public class AssemblingTableIHandler implements IItemHandler {
    private final AssemblingTableBehavior behavior;

    public AssemblingTableIHandler(AssemblingTableBehavior behavior) {
